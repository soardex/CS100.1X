...
dayGroupedHosts = dayToHostPairTuple.groupByKey().map(lambda (k, v): (k, list(set(v))))
...
topErrDate = (errDateSorted.sortBy(lambda s: s[1], False)).take(5)
